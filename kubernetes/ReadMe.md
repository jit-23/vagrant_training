...
- Container runtime is a software that runs containers and is responsable for managing their lifecicly, including starting, stopping and removing containers.
